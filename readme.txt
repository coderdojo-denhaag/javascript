...
- Snake; het beroemde spelletje snake

2) Setup
De instructies staan beschreven in PDF bestanden. Je kunt code uit die bestanden kopiëren 
en plakken. Soms werkt de PDF lezer niet mee bij het kopiëren van de code en zet alles
op een enkele regel. Daarom kan je SumatraPDF installeren. PDF bestanden die je met
dit programma opent zijn altijd goed te lezen en te gebruiken. 
Als SumatraPDF nog niet op de laptop staat, kan je deze installeren (zie de map).

De code in HTML, JavaScript en CSS voeren we in via Visual Studio Code. Het installatie-
pakket staat hier: https://code.visualstudio.com/
